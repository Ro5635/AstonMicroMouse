...
$controllers = array('pages' => ['home', 'datatest','error'], 'dash' => ['home'] , 'secureajax' => ['verifymobile', 'resendmobileverification'] ,'ajax' => ['login', 'createaccount', 'newrun', 'log', 'getdemodatatable', 'manualcontrol'] , 'header' => ['std', 'error'] , 'footer' => ['std', 'error'] , 'login' => ['form'] , 'account' => ['verify']);
